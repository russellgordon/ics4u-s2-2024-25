...
First, please download the [Processing Data playground](https://www.russellgordon.ca/lcs/2024-25/ics4u/ProcessingData.playground.zip).

Double-click to expand the Zip file, and then open the playground:

![[Pasted image 20230330122300.png]]
...
A [companion video](https://www.youtube.com/watch?v=R8YHO_Jji04) is provided to help you complete this playground:

![[Pasted image 20230330122611.png]]

## Instructions to Get Started

Work through the playground and write responses in your own words to the [[#Questions to Consider|questions to consider]].
